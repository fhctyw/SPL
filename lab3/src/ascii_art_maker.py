...
class AsciiArtMaker(BaseProgram):
    def __init__(self) -> None:
        super().__init__()
        self.menu = ConsoleMenu(exit_option_text=_('Exit'))
        ...
        self.menu.append_item(FunctionItem(_('Create ASCII art'), self.__create_art))
        self.menu.append_item(FunctionItem(_('Show all fonts'), self.__show_fonts))
        self.menu.append_item(FunctionItem(_('Set font'), self.__set_font))
        self.menu.append_item(FunctionItem(_('Show all colors'), self.__show_colors))
        self.menu.append_item(FunctionItem(_('Set color'), self.__set_color))
        self.menu.append_item(FunctionItem(_('Show all arts'), self.__show_arts))
